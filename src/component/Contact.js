import { Box, Center, Container,  Divider, Grid, Title, createStyles, rem, PasswordInput, Button, TextInput } from '@mantine/core'
                                    ...
                                    >
                                        <Grid>
                                            ...
                                            <Grid.Col md={12} lg={12} sm={12}>
                                                <TextInput withAsterisk type='text' label="First Name" placeholder="Enter First Name"
                                            ...
                                            <Grid.Col md={12} lg={12} sm={12}>
                                                ...
                                                <TextInput type='text' label="Last Name" withAsterisk placeholder="Enter Last Name"
                                            ...
                                            <Grid.Col>
                                                <TextInput type='text' label="Email" withAsterisk placeholder="Enter your email"
                                            ...
                                            <Grid.Col md={6} lg={6} sm={12}>
                                                <PasswordInput label="Password" withAsterisk placeholder="Password"
                                                    {...form.getInputProps('password')}
                                                />
                                            </Grid.Col>
                                            <Grid.Col md={6} lg={6} sm={12}>
                                                <PasswordInput label="Confirm Password" withAsterisk placeholder="Confirm Password"
